...
subroutine solver(deltaEEelectr,sourceEEelectr,sinkEEelectr,    & ! Single location hourly energy balances
      ...
      ! Aggregated locations, whole year balances initialization (outern inizialization)
      ...
      do 3000 itime=iTimeStart,iTimeEnd ! Hours of the year passing
        ...
        ! Aggregated locations, hourly balances initialization (each year, inner inizialization)
